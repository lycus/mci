...
public final class DGarbageCollector : GarbageCollector
{
    ...
    public override RuntimeObject* createWeak(RuntimeObject* target)
    {
        ...
        auto addr = cast(Weak!WeakBox*)(cast(size_t)weak + computeOffset(first(weakType.members).y, mci.core.config.is32Bit, simdAlignment));
    ...
    {
        auto weakObj = cast(Weak!WeakBox*)(cast(size_t)weak + computeOffset(first(weakType.members).y, mci.core.config.is32Bit, simdAlignment));
