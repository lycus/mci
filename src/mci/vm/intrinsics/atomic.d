...
extern (C)
{
    public ubyte mci_atomic_exchange_u(VirtualMachineContext context, size_t* ptr, size_t condition, size_t value)
    {
    ...
    public ubyte mci_atomic_exchange_s(VirtualMachineContext context, isize_t* ptr, isize_t condition, isize_t value)
    {
        // Do a cast; we don't want to introduce shared in the intrinsics.
        return cas(cast(shared)ptr, condition, value);
    }
